...
#export SELECTIONS="s2b0jresolved s1b1jresolved"
#export SELECTIONS="s2b0jresolved"

#export NAMESAMPLE="ggHH_bbtt"
export NAMESAMPLE="HH_SM"
...
do
    ...
    ###python chcardMaker.py -f ${SOURCE}/MT2_studies/wrapped/analyzedOutPlotter_${c}_MT2.root -o "_${OUTSTRING}" -c ${c} -i ${SOURCE}/config/mainCfg_${c}_MT2.cfg -s ${BASE} ${RESONANT} -u 0 -t
    python chcardMaker.py -f ${SOURCE}/MT2_studies/wrapped/analyzedOutPlotter_${c}_MT2_80.root -o "_${OUTSTRING}" -c ${c} -i ${SOURCE}/config/mainCfg_${c}_MT2.cfg -s ${BASE} ${RESONANT} -u 0 -t
...
echo "*** START LIMIT per CHANNEL/CATEGORY ***"
