...
export OUTSTRING="test_$1"
export DUMMY="$1"
export STRINGLEPTONS=""
...
export SELECTIONS="baselineVBF_btagMfirst"
...
do
	...
	echo "$BASE"
	python chcardMaker.py -f analyzedOutPlotter_w.root -o "_${OUTSTRING}" -c ${c} -i ${SOURCE}/analysis_${c}_VBF16Aprile2018/mainCfg_VBF_${c}.cfg -y -s ${BASE} ${RESONANT} -u 1 -t 
#done
