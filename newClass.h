...
// Sat Aug  5 12:37:55 2017 by ROOT version 6.02/05
// from TTree HTauTauTree/small tree for HH analysis
// found on file: comb_test/output_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         LepTauKine;
   Float_t         BDTResonant;
   Float_t         BDTResonantHM;
   Float_t         BDTResonantLM;
   Float_t         BDTNonResonant;
   ...
   TBranch        *b_BDTResonantHM;   //!
   TBranch        *b_BDTResonantLM;   //!
   TBranch        *b_BDTNonResonant;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("comb_test/output_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("comb_test/output_0.root");
      }
...
void newClass::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("passTrgBBres", &passTrgBBres, &b_passTrgBBres);
   fChain->SetBranchAddress("passTrgBBnonres", &passTrgBBnonres, &b_passTrgBBnonres);
   fChain->SetBranchAddress("passTrgGG", &passTrgGG, &b_passTrgGG);
   ...
   fChain->SetBranchAddress("BDTResonantHM", &BDTResonantHM, &b_BDTResonantHM);
   fChain->SetBranchAddress("BDTResonantLM", &BDTResonantLM, &b_BDTResonantLM);
   fChain->SetBranchAddress("BDTNonResonant", &BDTNonResonant, &b_BDTNonResonant);
   Notify();
}
