...
if ntest == 1:
    ...
    c2v = 1
    kl  = 1
    title = 'k_{2V} scan - target node 1 cV,c2V,kl=(1,1,1)'
    h_target = h_1_1_1.Clone('h_target')
    xs_target = xs_1_1_1
    oname = 'c2v_scan_target_node1_rew'+str(nRew)+'.pdf'
...
# node3 incluso nel sistema
    ...
    c2v = 1
    kl  = 2
    title = 'k_{2V} scan - target node 3 cV,c2V,kl=(1,1,2)'
    h_target = h_1_1_2.Clone('h_target')
    xs_target = xs_1_1_2
    oname = 'c2v_scan_target_node3_rew'+str(nRew)+'.pdf'
...
# node7 molto diverso da tutto
    ...
    c2v = 0
    kl  = 4
    title = 'k_{2V} scan - target node 7 cV,c2V,kl=(-2,0,4)'
    h_target = h_m2_0_4.Clone('h_target')
    xs_target = xs_m2_0_4
    oname = 'c2v_scan_target_node7_rew'+str(nRew)+'.pdf'
...
# node11 simile al sistema
    ...
    c2v = 1
    kl  = 4
    title = 'k_{2V} scan - target node 11 cV,c2V,kl=(1,1,4)'
    h_target = h_1_1_4.Clone('h_target')
    xs_target = xs_1_1_4
    oname = 'c2v_scan_target_node11_rew'+str(nRew)+'.pdf'
...
# node12 simile al sistema
    ...
    c2v = 1
    kl  = -2
    title = 'k_{2V} scan - target node 12 cV,c2V,kl=(1,1,-2)'
    h_target = h_1_1_m2.Clone('h_target')
    xs_target = xs_1_1_m2
    oname = 'c2v_scan_target_node12_rew'+str(nRew)+'.pdf'
...
# node13 simile al sistema
    ...
    c2v = 1
    kl  = -4
    title = 'k_{2V} scan - target node 13 cV,c2V,kl=(1,1,-4)'
    h_target = h_1_1_m4.Clone('h_target')
    xs_target = xs_1_1_m4
    oname = 'c2v_scan_target_node13_rew'+str(nRew)+'.pdf'
...
# node15 ha c2v diverso
    ...
    c2v = 4
    kl  = 1
    title = 'k_{2V} scan - target node 15 cV,c2V,kl=(1,4,1)'
    h_target = h_1_4_1.Clone('h_target')
    xs_target = xs_1_4_1
    oname = 'c2v_scan_target_node15_rew'+str(nRew)+'.pdf'
...
# node5 ha cv diverso
    ...
    c2v = 1
    kl  = 1
    title = 'k_{2V} scan - target node 5 cV,c2V,kl=(1.5,1,1)'
    h_target = h_1p5_1_1.Clone('h_target')
    xs_target = xs_1p5_1_1
    oname = 'c2v_scan_target_node5_rew'+str(nRew)+'.pdf'
...
# node9 tutto negativo
    ...
    c2v = -1
    kl  = -1
    title = 'k_{2V} scan - target node 9 cV,c2V,kl=(-1,-1,-1)'
    h_target = h_m1_m1_m1.Clone('h_target')
    xs_target = xs_m1_m1_m1
    oname = 'c2v_scan_target_node9_rew'+str(nRew)+'.pdf'
...
# node4 simile al sistema3
    ...
    c2v = 2
    kl  = 1
    title = 'k_{2V} scan - target node 4 cV,c2V,kl=(1,2,1)'
    h_target = h_1_2_1.Clone('h_target')
    xs_target = xs_1_2_1
    oname = 'c2v_scan_target_node4_rew'+str(nRew)+'.pdf'
...
# node16 simile al sistema3
    ...
    c2v = -2
    kl  = 1
    title = 'k_{2V} scan - target node 16 cV,c2V,kl=(1,-2,1)'
    h_target = h_1_m2_1.Clone('h_target')
    xs_target = xs_1_m2_1
    oname = 'c2v_scan_target_node16_rew'+str(nRew)+'.pdf'
...
if nRew == 1:
    print '--> REWIGHTING: 1 - nodes 1,4,10'
    xs_x = -1. * xs_1_1_1 + 0.5 * xs_1_2_1 + 0.5 * xs_4_0_0
    xs_y =  2. * xs_1_1_1 - 0.5 * xs_1_2_1 - 1.5 * xs_4_0_0
    xs_z =                                    1. * xs_4_0_0

if nRew == 2:
    print '--> REWIGHTING: 2 - nodes 1,4,9'
    xs_x = -0.5 * xs_1_1_1 + (1./3.) * xs_1_2_1 + (1./6.) * xs_m1_m1_m1
    xs_y =  0.5 * xs_1_1_1                      -     0.5 * xs_m1_m1_m1
    xs_z =   1. * xs_1_1_1 - (1./3.) * xs_1_2_1 + (1./3.) * xs_m1_m1_m1

if nRew == 3:
    print '--> REWIGHTING: 3 - nodes 1,14,15'
    xs_x = -(1./3.) * xs_1_1_1 + 0.25 * xs_1_0_1 + (1./12.) * xs_1_4_1
    xs_y =  (4./3.) * xs_1_1_1 - 1.25 * xs_1_0_1 - (1./12.) * xs_1_4_1
    xs_z =                         1. * xs_1_0_1
...
if nRew == 1:
    h_x = get_composed_h([(h_1_1_1, -1.), (h_1_2_1,  0.5), (h_4_0_0,  0.5)], 'h_x', xs_x)
    h_y = get_composed_h([(h_1_1_1,  2.), (h_1_2_1, -0.5), (h_4_0_0, -1.5)], 'h_y', xs_y)
    h_z = get_composed_h([(h_1_1_1,  0.), (h_1_2_1,   0.), (h_4_0_0,   1.)], 'h_z', xs_z)

if nRew == 2:
    h_x = get_composed_h([(h_1_1_1, -0.5), (h_1_2_1,  (1./3.)), (h_m1_m1_m1, (1./6.))], 'h_x', xs_x)
    h_y = get_composed_h([(h_1_1_1,  0.5), (h_1_2_1,       0.), (h_m1_m1_m1,    -0.5)], 'h_y', xs_y)
    h_z = get_composed_h([(h_1_1_1,   1.), (h_1_2_1, -(1./3.)), (h_m1_m1_m1, (1./3.))], 'h_z', xs_z)

if nRew == 3:
    h_x = get_composed_h([(h_1_1_1, -(1./3.)), (h_1_0_1,  0.25), (h_1_4_1,  (1./12.))], 'h_x', xs_x)
    h_y = get_composed_h([(h_1_1_1,  (4./3.)), (h_1_0_1, -1.25), (h_1_4_1, -(1./12.))], 'h_y', xs_y)
    h_z = get_composed_h([(h_1_1_1,       0.), (h_1_0_1,    1.), (h_1_4_1,        0.)], 'h_z', xs_z)
