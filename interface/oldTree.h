...
// Tue Nov 21 16:14:25 2017 by ROOT version 6.02/05
// from TTree HTauTauTree/small tree for HH analysis
// found on file: /data_CMS/cms/amendola/HH2017Skims/Skims2017_sync/SKIM_TT_TuneCUETP8M2/output_1.root
//////////////////////////////////////////////////////////
...
#ifdef oldTree_cxx
oldTree::oldTree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data_CMS/cms/amendola/HH2017Skims/Skims2017_sync/SKIM_TT_TuneCUETP8M2/output_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data_CMS/cms/amendola/HH2017Skims/Skims2017_sync/SKIM_TT_TuneCUETP8M2/output_1.root");
      }
...
Int_t oldTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t oldTree::LoadTree(Long64_t entry)
{
...
void oldTree::Show(Long64_t entry)
{
...
Int_t oldTree::Cut(Long64_t entry)
{
