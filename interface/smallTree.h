...
//      m_smallT->Branch ("", &m_, "/F") ;
      ...
      m_smallT->Branch ("LHE_H1_e", &m_LHE_H1_e,"LHE_H1_e/F");
      ...
      m_smallT->Branch ("LHE_H2_e", &m_LHE_H2_e,"LHE_H2_e/F");
      ...
      m_smallT->Branch ("LHE_VBF1_e", &m_LHE_VBF1_e,"LHE_VBF1_e/F");
      ...
      m_smallT->Branch ("LHE_VBF2_e", &m_LHE_VBF2_e,"LHE_VBF2_e/F");
