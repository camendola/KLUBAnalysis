...
struct smallTree
{
  ...
  int init () 
    {      
      ...
      m_smallT->Branch ("genmuon1_Pt", &m_genmuon1_Pt, "genmuon1_Pt/F") ;
      m_smallT->Branch ("genmuon1_Et", &m_genmuon1_Et, "genmuon1_Et/F") ;
      m_smallT->Branch ("genmuon1_Phi", &m_genmuon1_Phi, "genmuon1_Phi/F") ;
      m_smallT->Branch ("genmuon1_Eta", &m_genmuon1_Eta, "genmuon1_Eta/F") ;

      m_smallT->Branch ("genmuon1_Pt", &m_genmuon2_Pt, "genmuon2_Pt/F") ;
      m_smallT->Branch ("genmuon2_Et", &m_genmuon2_Et, "genmuon2_Et/F") ;
      m_smallT->Branch ("genmuon2_Phi", &m_genmuon2_Phi, "genmuon2_Phi/F") ;
      m_smallT->Branch ("genmuon2_Eta", &m_genmuon2_Eta, "genmuon2_Eta/F") ;
...
//    Float_t         metphi;
  ...
  Float_t m_genmuon1_Pt;
  Float_t m_genmuon1_Et;
  Float_t m_genmuon1_Eta;
  Float_t m_genmuon1_Phi;

  Float_t m_genmuon2_Pt;
  Float_t m_genmuon2_Et;
  Float_t m_genmuon2_Eta;
  Float_t m_genmuon2_Phi;
